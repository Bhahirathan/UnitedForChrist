package com.lordalmighty.unitedforchrist.activities;

import java.util.List;

import com.lordalmighty.unitedforchrist.*;
import com.lordalmighty.unitedforchrist.adapters.VerseAdapter;
import com.lordalmighty.unitedforchrist.data.Book;
import com.lordalmighty.unitedforchrist.data.Bookmarks;
import com.lordalmighty.unitedforchrist.data.Verse;
import com.lordalmighty.unitedforchrist.providers.BibleLibrary;
...
public class ChapterActivity extends ListActivity implements OnItemLongClickListener {
	...
	if (this.bookId == 1 && this.chapter == 1) {
	    Toast.makeText(this, "You are currently at the beginning of the unitedforchrist", Toast.LENGTH_SHORT).show();
	    // Do nothing
	}
	...
	if (this.book != null)
	    this.setTitle(this.book+" "+ this.chapter);
