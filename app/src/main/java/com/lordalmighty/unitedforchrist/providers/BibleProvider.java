package com.lordalmighty.unitedforchrist.providers;
...
public class BibleProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.lordalmighty.unitedforchrist.bibleprovider";
    ...
    */
	...
	switch (match) {
	case TESTAMENTS:
	    return "vnd.android.cursor.dir/vnd.lordalmighty.testament";
	case TESTAMENT_ID:
	    return "vnd.android.cursor.item/vnd.lordalmighty.testament";
	case BOOKS:
	    return "vnd.android.cursor.dir/vnd.lordalmighty.book";
	case BOOK_ID:
	    return "vnd.android.cursor.item/vnd.lordalmighty.book";
	case CHAPTERS:
	    return "vnd.android.cursor.dir/vnd.lordalmighty.chapter";
	case CHAPTER_ID:
	    return "vnd.android.cursor.item/vnd.lordalmighty.chapter";
	case VERSES:
	    return "vnd.android.cursor.dir/vnd.lordalmighty.verse";
	case VERSE_NUMBER:
	case VERSE_ID:
	    return "vnd.android.cursor.item/vnd.lordalmighty.verse";
	default:
	    return null;
	}
    }
